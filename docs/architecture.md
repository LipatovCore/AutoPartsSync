...
- Рекомендуемый вариант: перейти на кастомную модель пользователя Django с email как основным идентификатором входа.
...
- `employees.models`
  Планируемая зона хранения модели сотрудника и модели приглашения на активацию.
...
- Сотрудник
  Планируемая пользовательская сущность с email как идентификатором входа.
  Должна хранить статус доступа, признаки активности и служебные поля аудита.

- Приглашение сотрудника
  Отдельная сущность для одноразового токена установки пароля.
  Должна хранить только хеш токена, срок действия, время использования, признак отзыва и администратора, выпустившего ссылку.
